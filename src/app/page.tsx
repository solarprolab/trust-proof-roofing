...
const faqItems = [
  ...
  { q: 'How much does a roof replacement cost in Connecticut?', a: 'Most CT homeowners pay $12,000–$16,000 for a full roof replacement, depending on size, pitch, layers, and materials. We provide a free instant estimate online and a detailed written proposal with no obligation.' },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step) => (
              <div key={step.n} className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                <div className="text-4xl font-black text-[#38BDF8] mb-3">{step.n}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((service) => (
              <Link
                ...
                className="group bg-white border border-gray-200 rounded-2xl p-6 hover:border-[#38BDF8] hover:shadow-lg transition-all"
              >
      ...
      <section className="bg-[#0a1f3d] py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-4 bg-[#38BDF8] hover:bg-[#0EA5E9] text-white font-black rounded-xl text-lg transition-colors"
            >

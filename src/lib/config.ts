...
export const SERVICES: Service[] = [
  {
    ...
    description: 'Complete roof replacement. We install leading manufacturer brands including GAF and Owens Corning. 20-year leak warranty and manufacturer warranties up to 50 years.',
    metaTitle: 'Roof Replacement in Connecticut',
    metaDescription: 'Complete roof replacement in CT. We install leading manufacturer brands including GAF and Owens Corning. 20-year leak warranty, manufacturer warranties up to 50 years. Free estimate.',
    icon: '🏠',
    features: [
      'Licensed and insured — CT HIC #HIC.0703927',
      'Leading manufacturer brands including GAF and Owens Corning',

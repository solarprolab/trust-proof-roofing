        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-blue-300 text-sm leading-relaxed">
              Connecticut's most trusted roofing company. Serving Suffield and surrounding communities since 2004.
            </p>
            <div className="mt-4">
              <WarrantyBadge small />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-blue-200">
                ...
                <a href="tel:+18605550192" className="hover:text-white">(860) 555-0192</a>
              </li>
              <li className="flex items-start gap-2 text-blue-200">
                <svg className="w-4 h-4 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@trustproofroofing.com" className="hover:text-white">info@trustproofroofing.com</a>
              </li>
              <li className="flex items-start gap-2 text-blue-200">
                <svg className="w-4 h-4 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>123 Hartford Rd, Suffield, CT 06078</span>
              </li>
            </ul>
          </div>
        </div>
